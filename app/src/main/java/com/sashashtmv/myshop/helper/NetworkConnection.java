...
public class NetworkConnection {
    ...
    public static final String ERR_DIALOG_TITLE = "Интернет соединение не обнаружено !";
    private static final String ERR_DIALOG_MSG = "Похоже, наше приложение не может обнаружить активное интернет-соединение, " +
            "пожалуйста, проверьте настройки сети вашего устройства.";
    private static final String ERR_DIALOG_POSITIVE_BTN = "Настройки";
    private static final String ERR_DIALOG_NEGATIVE_BTN = "Отклонить";
